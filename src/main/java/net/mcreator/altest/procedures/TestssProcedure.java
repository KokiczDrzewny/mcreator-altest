...
public class TestssProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				AltestMod.LOGGER.warn("Failed to load dependency entity for procedure Testss!");
			return;
		}
		...
		}.getItemStack((int) (0))).getItem() == Blocks.COBBLESTONE.asItem()) {
