...
import net.mcreator.altest.entity.renderer.BugRenderer;
import net.mcreator.altest.AltestModElements;

@AltestModElements.ModElement.Tag
public class BugEntity extends AltestModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -10066330, -3355444, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("bug_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("altest:plains_c").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
