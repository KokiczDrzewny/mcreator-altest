...
package net.mcreator.altest.entity;
...
import net.mcreator.altest.entity.renderer.FriendlyCreeperRenderer;
import net.mcreator.altest.AltestModElements;

@AltestModElements.ModElement.Tag
public class FriendlyCreeperEntity extends AltestModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15013064, -14637027, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("friendly_creeper_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 15, 1, 2));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(7, new PanicGoal(this, 0.5));
			this.goalSelector.addGoal(8, new BreakBlockGoal(Blocks.STONE, this, 1, (int) 3));
		}
		...
		public void playStepSound(BlockPos pos, BlockState blockIn) {
			this.playSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.sand.place")), 0.15f, 1);
		}
