...
import net.mcreator.altest.item.FlSlimeItem;
import net.mcreator.altest.entity.renderer.FlyingSlimeRenderer;
import net.mcreator.altest.AltestModElements;

import java.util.Random;

@AltestModElements.ModElement.Tag
public class FlyingSlimeEntity extends AltestModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13393033, -13860017, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("flying_slime_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("altest:cherry").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new AvoidEntityGoal(this, SlimeEntity.class, (float) 6, 1, 1.2));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(FlSlimeItem.block));
		}

		@Override
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.ender_dragon.flap"));
		}
