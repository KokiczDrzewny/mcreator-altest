...
public class PlainsBirchCBiome extends AltestModElements.ModElement {
	public static Biome biome;

	public PlainsBirchCBiome(AltestModElements instance) {
		super(instance, 601);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-6697984).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(-6697984).withFoliageColor(-13395712).withGrassColor(-10040320).build();
				...
				event.getRegistry().register(biome.setRegistryName("altest:plains_birch_c"));
			}
		}
	}
