...
public class DesertCBiome extends AltestModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-205).setWaterColor(-16737946).setWaterFogColor(-16738048)
						.withSkyColor(-205).withFoliageColor(-3355648).withGrassColor(-6711040).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.DISK
								.withConfiguration(new SphereReplaceConfig(Blocks.SAND.getDefaultState(), FeatureSpread.func_242253_a(2, 4), 2,
										ImmutableList.of(Blocks.SAND.getDefaultState(), Blocks.SANDSTONE.getDefaultState())))
				...
				event.getRegistry().register(biome.setRegistryName("altest:desert_c"));
			}
		}
	}
