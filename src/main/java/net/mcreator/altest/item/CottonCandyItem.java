...
public class CottonCandyItem extends AltestModElements.ModElement {
	@ObjectHolder("altest:cotton_candy")
	...
	public static class ItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			ItemStack retval = new ItemStack(PlasticStickItem.block);
