...
public class WoodenHammerItem extends AltestModElements.ModElement {
	@ObjectHolder("altest:wooden_hammer")
	public static final Item block = null;

	public WoodenHammerItem(AltestModElements instance) {
		super(instance, 45);
	}
	...
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(ItemGroup.TOOLS).maxDamage(56));
		}
