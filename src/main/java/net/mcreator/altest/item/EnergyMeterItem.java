...
public class EnergyMeterItem extends AltestModElements.ModElement {
	@ObjectHolder("altest:energy_meter")
	...
	public static class ItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			EnergyMeterRightclickedProcedure.executeProcedure(Stream
