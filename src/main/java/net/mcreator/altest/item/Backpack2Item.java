...
import net.mcreator.altest.gui.Backpack2UIGuiWindow;
import net.mcreator.altest.gui.Backpack2UIGui;
...
public class Backpack2Item extends AltestModElements.ModElement {
	@ObjectHolder("altest:backpack_2")
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof Backpack2UIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Tier 2 Backpack");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new Backpack2UIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
