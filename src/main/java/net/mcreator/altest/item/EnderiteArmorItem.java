...
public class EnderiteArmorItem extends AltestModElements.ModElement {
	@ObjectHolder("altest:enderite_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("altest:enderite_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("altest:enderite_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("altest:enderite_armor_boots")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "altest:textures/models/armor/enderite_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
