...
import net.mcreator.altest.gui.Backpack3UIGuiWindow;
import net.mcreator.altest.gui.Backpack3UIGui;
...
public class Backpack3Item extends AltestModElements.ModElement {
	@ObjectHolder("altest:backpack_3")
	public static final Item block = null;

	public Backpack3Item(AltestModElements instance) {
		super(instance, 366);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof Backpack3UIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Tier 3 Backpack");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new Backpack3UIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
