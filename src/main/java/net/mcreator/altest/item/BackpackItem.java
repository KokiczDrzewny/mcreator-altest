...
import net.mcreator.altest.gui.BackpackUIGuiWindow;
...
public class BackpackItem extends AltestModElements.ModElement {
	@ObjectHolder("altest:backpack")
	public static final Item block = null;

	public BackpackItem(AltestModElements instance) {
		super(instance, 364);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof BackpackUIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Tier 1 Backpack");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new BackpackUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
