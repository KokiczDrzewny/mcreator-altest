...
public class DiamondHammerItem extends AltestModElements.ModElement {
	@ObjectHolder("altest:diamond_hammer")
	public static final Item block = null;

	public DiamondHammerItem(AltestModElements instance) {
		super(instance, 49);
	}
