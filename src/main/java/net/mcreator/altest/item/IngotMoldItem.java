...
public class IngotMoldItem extends AltestModElements.ModElement {
	@ObjectHolder("altest:ingot_mold")
	public static final Item block = null;

	public IngotMoldItem(AltestModElements instance) {
		super(instance, 322);
	}
