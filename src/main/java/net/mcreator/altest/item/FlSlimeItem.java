...
import net.mcreator.altest.entity.renderer.FlSlimeRenderer;
import net.mcreator.altest.AltestModElements;

import java.util.Random;

@AltestModElements.ModElement.Tag
public class FlSlimeItem extends AltestModElements.ModElement {
	@ObjectHolder("altest:fl_slime")
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 0.5, 5);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(FlSlimeItem.block);
		}
