...
public class YellowFlowerBlock extends AltestModElements.ModElement {
	@ObjectHolder("altest:yellow_flower")
	public static final Block block = null;

	public YellowFlowerBlock(AltestModElements instance) {
		super(instance, 251);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("yellow_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("altest:yellow_flower"), configuredFeature);
		}
	}
