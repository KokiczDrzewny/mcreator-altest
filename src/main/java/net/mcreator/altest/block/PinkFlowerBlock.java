...
public class PinkFlowerBlock extends AltestModElements.ModElement {
	@ObjectHolder("altest:pink_flower")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pink_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("altest:pink_flower"), configuredFeature);
		}
	}
