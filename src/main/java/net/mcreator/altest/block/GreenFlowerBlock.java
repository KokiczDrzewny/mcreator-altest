...
public class GreenFlowerBlock extends AltestModElements.ModElement {
	@ObjectHolder("altest:green_flower")
	public static final Block block = null;

	public GreenFlowerBlock(AltestModElements instance) {
		super(instance, 240);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("green_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("altest:green_flower"), configuredFeature);
		}
	}
