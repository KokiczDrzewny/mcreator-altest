...
public class PlantBlock extends AltestModElements.ModElement {
	@ObjectHolder("altest:plant")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("altest:plant"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		...
		public boolean isValidPosition(BlockState blockstate, IWorldReader worldIn, BlockPos pos) {
			...
			return ground == this || (ground == Blocks.GRASS_BLOCK || ground == Blocks.PODZOL || ground == Blocks.MYCELIUM || ground == Blocks.DIRT
					|| ground == Blocks.COARSE_DIRT || ground == Blocks.SAND || ground == Blocks.RED_SAND || ground == Blocks.GRAVEL
