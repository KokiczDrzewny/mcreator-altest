...
public class GalaxyPressurePlateBlock extends AltestModElements.ModElement {
	@ObjectHolder("altest:galaxy_pressure_plate")
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("galaxy_pressure_plate");
		}
