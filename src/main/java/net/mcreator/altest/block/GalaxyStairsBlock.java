...
public class GalaxyStairsBlock extends AltestModElements.ModElement {
	@ObjectHolder("altest:galaxy_stairs")
	public static final Block block = null;

	public GalaxyStairsBlock(AltestModElements instance) {
		super(instance, 91);
	}
