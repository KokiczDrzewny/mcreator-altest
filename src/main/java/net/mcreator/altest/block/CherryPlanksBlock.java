...
public class CherryPlanksBlock extends AltestModElements.ModElement {
	@ObjectHolder("altest:cherry_planks")
	public static final Block block = null;

	public CherryPlanksBlock(AltestModElements instance) {
		super(instance, 80);
	}
