...
public class CrystalizedFluidBlock extends AltestModElements.ModElement {
	@ObjectHolder("altest:crystalized_fluid")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("altest:crystalized_fluid_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;

	public CrystalizedFluidBlock(AltestModElements instance) {
		super(instance, 409);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes
						.builder(new ResourceLocation("altest:blocks/crystalizedfluid"), new ResourceLocation("altest:blocks/crystalizedfluid"))
						.luminosity(0).density(1000).viscosity(1000).temperature(300)

						.rarity(Rarity.COMMON))
				.explosionResistance(100f)

				.tickRate(6).levelDecreasePerBlock(1).slopeFindDistance(2).bucket(() -> bucket).block(() -> block);
		still = (FlowingFluid) new CustomFlowingFluid.Source(fluidproperties).setRegistryName("crystalized_fluid");
		flowing = (FlowingFluid) new CustomFlowingFluid.Flowing(fluidproperties).setRegistryName("crystalized_fluid_flowing");
		elements.blocks
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("crystalized_fluid_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("altest:crystalized_fluid_lakes"), configuredFeature);
		}
	}
