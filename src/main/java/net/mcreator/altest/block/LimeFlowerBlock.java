...
public class LimeFlowerBlock extends AltestModElements.ModElement {
	@ObjectHolder("altest:lime_flower")
	public static final Block block = null;

	public LimeFlowerBlock(AltestModElements instance) {
		super(instance, 252);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("lime_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("altest:lime_flower"), configuredFeature);
		}
	}
