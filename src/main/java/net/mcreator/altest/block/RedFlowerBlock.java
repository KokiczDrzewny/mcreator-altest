...
public class RedFlowerBlock extends AltestModElements.ModElement {
	@ObjectHolder("altest:red_flower")
	public static final Block block = null;

	public RedFlowerBlock(AltestModElements instance) {
		super(instance, 236);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("red_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("altest:red_flower"), configuredFeature);
		}
	}
