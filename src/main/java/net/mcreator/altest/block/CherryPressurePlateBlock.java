...
public class CherryPressurePlateBlock extends AltestModElements.ModElement {
	@ObjectHolder("altest:cherry_pressure_plate")
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("cherry_pressure_plate");
		}
