...
public class GalaxyPlanksBlock extends AltestModElements.ModElement {
	@ObjectHolder("altest:galaxy_planks")
	public static final Block block = null;

	public GalaxyPlanksBlock(AltestModElements instance) {
		super(instance, 90);
	}
