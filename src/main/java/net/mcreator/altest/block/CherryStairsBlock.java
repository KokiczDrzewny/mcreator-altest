...
public class CherryStairsBlock extends AltestModElements.ModElement {
	@ObjectHolder("altest:cherry_stairs")
	public static final Block block = null;

	public CherryStairsBlock(AltestModElements instance) {
		super(instance, 81);
	}
